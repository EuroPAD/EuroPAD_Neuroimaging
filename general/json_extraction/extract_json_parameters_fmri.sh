...
# extracts fMRI parameters from each session of each subject in a dataset

## FROM FMRIPREP DIR

#studydir=/home/radv/$USER/my-rdisk/r-divi/RNG/Projects/ExploreASL/EuroPAD/derivatives
#rawdir=$studydir/fmriprep-v23.0.1

#file_JsonParameters=/home/radv/$USER/my-rdisk/r-divi/RNG/Projects/ExploreASL/EuroPAD/projects/sfc_prithvi/FMRI_JSON_Parameters_$(date +"%Y_%m_%d").csv
...
file_JsonParameters=/home/radv/$USER/my-rdisk/r-divi/RNG/Projects/ExploreASL/EuroPAD/projects/sfc_prithvi/FMRI_ALL_JSON_Parameters_$(date +"%Y_%m_%d").csv
