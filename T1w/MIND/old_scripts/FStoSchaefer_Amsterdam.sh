...
if [ -f ${freesurfer_dir}/${i}/label/lh.Schaefer2018_100Parcels_7Networks_order.annot -a -f ${freesurfer_dir}/${i}/label/rh.Schaefer2018_100Parcels_7Networks_order.annot ]; then
  echo "${i} already OK"
else
  mri_surf2surf --hemi lh \
    --srcsubject fsaverage \
    --trgsubject ${i} \
    --sval-annot ${code_dir}/label/lh.Schaefer2018_100Parcels_7Networks_order.annot \
    --tval ${SUBJECTS_DIR}/${i}/label/lh.Schaefer2018_100Parcels_7Networks_order.annot
    
  mri_surf2surf --hemi rh \
    --srcsubject fsaverage \
    --trgsubject ${i} \
    --sval-annot ${code_dir}/label/rh.Schaefer2018_100Parcels_7Networks_order.annot \
    --tval ${SUBJECTS_DIR}/${i}/label/rh.Schaefer2018_100Parcels_7Networks_order.annot
  ...
  mris_anatomical_stats \
    -f ${SUBJECTS_DIR}/${i}/stats/lh.Schaefer2018_100Parcels_7Networks_order.stats \
    -b -a ${SUBJECTS_DIR}/${i}/label/lh.Schaefer2018_100Parcels_7Networks_order.annot \
    ${i} lh
    
  mris_anatomical_stats \
    -f ${SUBJECTS_DIR}/${i}/stats/rh.Schaefer2018_100Parcels_7Networks_order.stats \
    -b -a ${SUBJECTS_DIR}/${i}/label/rh.Schaefer2018_100Parcels_7Networks_order.annot \
    ${i} rh
