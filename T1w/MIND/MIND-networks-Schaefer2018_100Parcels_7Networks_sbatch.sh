...
MIND_dir=/home/radv/$(whoami)/my-rdisk/r-divi/RNG/Projects/ExploreASL/EuroPAD/derivatives/MIND-freesurfer-v7.1.1-Schaefer2018_100Parcels/7Networks/
MIND_list=/home/radv/$(whoami)/my-rdisk/r-divi/RNG/Projects/ExploreASL/EuroPAD/derivatives/MIND-freesurfer-v7.1.1-Schaefer2018_100Parcels/MIND_list.txt
...
output_file="${MIND_dir}/${subject}_MIND-Schaefer2018_100Parcels_7Networks_order.csv"
...
python3 "${code_dir}/MIND-networks_Schaefer2018_100Parcels_7Networks.py" "$subject_path" -o "${MIND_dir}"
