...
export SUBJECTS_DIR=/home/radv/lpieperhoff/my-rdisk/r-divi/RNG/Projects/ExploreASL/EPAD/derivatives/FreeSurfer_longitudinal # FreeSurfer directory
sub_dir=/home/radv/lpieperhoff/my-rdisk/r-divi/RNG/Projects/ExploreASL/EPAD/derivatives/FreeSurfer_longitudinal/
...
for atlas in ${atlases[@]}; do
	for sub in $(ls -d $SUBJECTS_DIR/sub-*ses*); do
		sub=$(basename ${sub})
