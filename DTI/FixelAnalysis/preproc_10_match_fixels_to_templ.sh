...
#1.Match subject level fixel to template fixels to obtain fixel correspondence
...
if [ ! -f $fixeldir/template/fd/${subname}_${sesname}.mif ]; then 
...
sbatch auxiliary_functions/fixelcorrespondence_array.sh  $qsirecdir $fixeldir $QCdir
