...
fixelcorrespondence $fixeldir/subjects/$subject/$session/dwi/${subject}_${session}_space-FODtemplate_wmFixels/fd.mif $fixeldir/template/fixel_mask $fixeldir/template/fd ${subject}_${session}.mif
