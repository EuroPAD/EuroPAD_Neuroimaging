...
h5_path <- "/scratch/radv/mtranfa/Fixelwise/wb_fdc_smooth.h5"
...
phenotypes <- read.csv(file.path(datadir,"wb_fdc_smooth_cohort.csv"))

EPAD_fixel$source_file <- paste0("fdc_smooth/",EPAD_fixel$subject_id, ".mif")
