...
h5_path <- "/scratch/radv/mtranfa/Fixelwise/wb_fd_smooth.h5"
...
phenotypes <- read.csv(file.path(datadir,"wb_fd_smooth_cohort.csv"))

EPAD_fixel$source_file <- paste0("fd_smooth/",EPAD_fixel$subject_id, ".mif")
