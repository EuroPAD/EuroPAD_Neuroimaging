...
h5_path <- "/scratch/radv/mtranfa/Fixelwise/wb_log_fc_smooth.h5"
...
phenotypes <- read.csv(file.path(datadir,"wb_log_fc_smooth_cohort.csv"))

EPAD_fixel$source_file <- paste0("log_fc_smooth/",EPAD_fixel$subject_id, ".mif")
