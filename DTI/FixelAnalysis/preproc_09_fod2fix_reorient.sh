...
if [ ! -d $fixeldir/subjects/${subname}/$sesname/dwi/${subname}_${sesname}_space-FODtemplate_wmFixels_not_reoriented ]; then 
...
sbatch auxiliary_functions/fod2fix_reorient_array.sh  $qsirecdir $fixeldir $QCdir
