...
for tract_name in ${tracts[@]};do
	...
	for prs in ${prsofint[@]};do
		output_dir=${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_third_pass_modified_cfe/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts
		echo ${prs}
		...
		if [[ ${prs} == "prs_apoe" ]];then
			...
			fixelcfestats ${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_second_pass/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts/${metric}_smooth_at_tract_level/${tract_name} -nshuffles 5000 -nthreads 12 -cfe_e 4 -cfe_c 1 -cfe_h 5 ${fixeldir}/statistics_files_final_models/files_prs_fd_int.txt  ${fixeldir}/statistics_files_final_models/design_matrix_fd_${prs}_tau_int.txt ${fixeldir}/statistics_files_final_models/contrasts_fd_prs_apoe_tau_int.txt ${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_second_pass/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts/matrix/ ${output_dir} -mask ${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_second_pass/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts/bundle_crop/extent_mask.mif -force
		
		else
			####no_apoe_prs
			mkdir -p ${output_dir}

			fixelcfestats ${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_second_pass/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts/${metric}_smooth_at_tract_level/${tract_name} -nshuffles 5000 -nthreads 12 -cfe_e 4 -cfe_c 1 -cfe_h 5 ${fixeldir}/statistics_files_final_models/files_prs_fd_int_${prs}.txt  ${fixeldir}/statistics_files_final_models/design_matrix_fd_${prs}_tau_int.txt ${fixeldir}/statistics_files_final_models/contrasts_fd_prsnoapoe_tau_int.txt ${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_second_pass/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts/matrix/ ${output_dir} -mask ${fixeldir}/tract_stats/final_models_rimask_null_contrib_results_5_perc_ext_mask_tau_immune_on_fd_second_pass/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts/bundle_crop/extent_mask.mif -force
		fi
	done
done
