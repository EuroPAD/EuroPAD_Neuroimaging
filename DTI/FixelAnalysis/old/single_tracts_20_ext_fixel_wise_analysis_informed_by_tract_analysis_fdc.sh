...
tracts=("CC_2" "CC_3" "CC_4" "CG" "CST" "SLF_I" "SLF_II") #"AF" "ATR" already done
...
for tract_name in ${tracts[@]};do
	...
	for prs in ${prsofint[@]};do
		output_dir=${fixeldir}/tract_stats/results_20_perc_ext_mask_single_bundles/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/contrasts
		echo ${prs}
