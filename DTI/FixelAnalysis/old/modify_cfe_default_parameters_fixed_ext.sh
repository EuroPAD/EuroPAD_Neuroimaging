...
for tract_name in ${tracts[@]};do
	...
	for prs in ${prsofint[@]};do
		...
		output_dir=${fixeldir}/tract_stats/modify_cfe_parameters_test/results_5_perc_ext_mask_single_bundles/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/modified_cfe_e4_h5/contrasts
		echo ${prs}
		...
		output_dir=${fixeldir}/tract_stats/modify_cfe_parameters_test/results_5_perc_ext_mask_single_bundles/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/modified_cfe_e3_h5/contrasts
		echo ${prs}
		if [[ ${prs} == "prs_apoe" ]];then
			...
			fixelcfestats ${fixeldir}/tract_fixels/${metric}_smooth_at_tract_level/${tract_name} -nshuffles 100 -nthreads 12 -cfe_e 3 -cfe_c 1 -cfe_h 5 ${fixeldir}/statistics_files/files_prs_fc_int.txt ${fixeldir}/statistics_files/design_matrix_fc_${prs}_int.txt ${fixeldir}/statistics_files/contrasts_fc_prs_apoe_int.txt ${fixeldir}/matrix/${metric}/${tract_name} ${output_dir} -mask ${fixeldir}/tract_fixels/${metric}/${tract_name}/extent_mask.mif -force
		...
		output_dir=${fixeldir}/tract_stats/modify_cfe_parameters_test/results_5_perc_ext_mask_single_bundles/${analysis_name}/${metric}_smooth/${prs}_int/${tract_name}/modified_cfe_e2_h5/contrasts
		echo ${prs}
		if [[ ${prs} == "prs_apoe" ]];then
			...
			fixelcfestats ${fixeldir}/tract_fixels/${metric}_smooth_at_tract_level/${tract_name} -nshuffles 100 -nthreads 12 -cfe_e 2 -cfe_c 1 -cfe_h 5 ${fixeldir}/statistics_files/files_prs_fc_int.txt ${fixeldir}/statistics_files/design_matrix_fc_${prs}_int.txt ${fixeldir}/statistics_files/contrasts_fc_prs_apoe_int.txt ${fixeldir}/matrix/${metric}/${tract_name} ${output_dir} -mask ${fixeldir}/tract_fixels/${metric}/${tract_name}/extent_mask.mif -force
