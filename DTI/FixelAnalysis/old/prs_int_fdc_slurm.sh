...
prsofint=("pathway1_immuneactiv_noapoe_BA" "pathway2_signaltrasd_noapoe_BA" "pathway3_inflammatory_noapoe_BA" "pathway4_migration_noapoe_BA" "pathway5_amyloid_noapoe_BA" "pathway6_cleaning_noapoe_BA")
