...
tracts=("main_effect_prsapoe_on_fd" "main_effect_prsnoapoe_on_fd" "main_effect_migration_on_fd" "main_effect_amyloid_pathway_on_fd" "interaction_amyloid_prsapoe_on_fd" "interaction_amyloid_prsnoapoe_on_fd" "interaction_amyloid_clearance_on_fd" "main_effect_tau_on_fd" "interaction_tau_immune_on_fd")
