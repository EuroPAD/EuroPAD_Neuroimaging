...
fixelcfestats ${fixeldir}/tract_fixels/${metric}_smooth_at_tract_level/${tract_name} -nshuffles 5000 -nthreads 12 ${fixeldir}/statistics_files/files_CSF_fd.txt  ${fixeldir}/statistics_files/design_matrix_fd_amyloid.txt ${fixeldir}/statistics_files/both_contrasts_fd_amyloid.txt ${fixeldir}/matrix/${metric}/${tract_name} ${fixeldir}/tract_stats/${tract_name}/${metric}_smooth/amyloid/both_contrasts -force

####tau
mkdir -p ${fixeldir}/tract_stats/${tract_name}/${metric}_smooth/tau/both_contrasts

fixelcfestats ${fixeldir}/tract_fixels/${metric}_smooth_at_tract_level/${tract_name} -nshuffles 5000 -nthreads 12 ${fixeldir}/statistics_files/files_CSF_fd.txt  ${fixeldir}/statistics_files/design_matrix_fd_tau.txt ${fixeldir}/statistics_files/both_contrasts_fd_tau.txt ${fixeldir}/matrix/${metric}/${tract_name} ${fixeldir}/tract_stats/${tract_name}/${metric}_smooth/tau/both_contrasts -force
