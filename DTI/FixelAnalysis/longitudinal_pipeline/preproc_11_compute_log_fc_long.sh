...
mkdir -p $fixeldir/template/log_fc_long
...
if [ ! -f $fixeldir/template/log_fc_long/${subname}_${sesname}.mif ]; then 
...
sbatch auxiliary_functions/compute_log_fc_longitudinal_array.sh  $qsirecdir $fixeldir $QCdir
