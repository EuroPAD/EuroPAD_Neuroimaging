...
cd $fixeldir
tckgen -angle 22.5 -maxlen 250 -minlen 10 -power 1.0 fod_template.mif -seed_image group_mask_intersection_long.mif -mask group_mask_intersection_long.mif -select 20000000 -cutoff 0.06 tracks_20_million_long.tck -nthreads 12

# SIFT
echo "running SIFT"
tcksift tracks_20_million_long.tck fod_template.mif tracks_2_million_sift_long.tck -term_number 2000000 -nthreads 12 # filter

# Fixel-to-fixel Connectivity
echo "computing fixel-to-fixel connectivity"
fixelconnectivity fixel_mask_long/ tracks_2_million_sift_long.tck matrix_long/ 
