...
if [[ ! -f $fixeldir/template/group_mask_intersection.mif ]] ; then
...
if [[ ! -d  $fixeldir/template/fixel_mask ]]; then 
fod2fixel -mask $fixeldir/template/group_mask_intersection.mif -fmls_peak_value 0.06 $fixeldir/template/fod_template.mif $fixeldir/template/fixel_mask -force # do fixels on template
else 
